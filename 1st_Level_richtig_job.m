%-----------------------------------------------------------------------
% Job saved on 04-Feb-2022 14:15:07 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
...
%%
matlabbatch{1}.spm.stats.fmri_spec.sess.cond.name = 'Rest';
matlabbatch{1}.spm.stats.fmri_spec.sess.cond.onset = 0;
matlabbatch{1}.spm.stats.fmri_spec.sess.cond.duration = 663;
